...
http://localhost:3000/abc/def?ghi=jkl
http://localhost:3000/prototype-admin/password?returnURL=http%3A%2F%2Flocalhost%3A3000%2Fabc%2Fdef
http://localhost:3000/abc/def?ghi=jkl

http://localhost:3000/prototype-admin/password
http://localhost:3000/
...
http://localhost:3000/prototype-admin/password
(immediately) http://localhost:3000/
